...
def full_config() -> v0_1.PartialConfiguration:
    ...
    components = [
        v0_1.Component("macro", "macro_impl", 10, v0_1.Ports(o_i=["out"], s=["in"])),
        v0_1.Component(
    ...
    implementations = [
        v0_1.Implementation(
            ...
            v0_1.BaseEnv.LOGIN,
            ["OpenMPI/4.1.0", "FFTW/3.1.0"],
            Path("/home/user/venv"),
            {"ENV1": "23"},
            v0_1.ExecutionModel.DIRECT,
            Path("/home/user/models/macro"),
            ["-a", "-b"],
            None,
        ),
        v0_1.Implementation(
    ...
    return v0_1.PartialConfiguration(
        model, settings, implementations, resources, description, checkpoints, resume
    )
